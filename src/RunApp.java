...
/*
 * 此类用于启动应用程序，创建 PassengerManager, FlightManager 和 Menu 实例。
 * This class is used to launch applications and create PassengerManager, FlightManager and Menu instances.
 */
public class RunApp {
