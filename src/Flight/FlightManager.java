...
public class FlightManager {
    ...
    public FlightInformation inputFlightInfo() {
        ...
        } while (!flightNumber.matches("\\d{6}"));
    ...
    public void updateFlightInfo() {
        ...
        // 选择要修改的航班
        FlightInformation flightToUpdate = selectFlight(flights);
        ...
        // 检查航班是否有乘客购票
        if (flightHasPassenger.getOrDefault(flightToUpdate.getFlightNumber(), false)) {
            System.out.println("该航班已有乘客购票，无法修改。");
            return;
        }
